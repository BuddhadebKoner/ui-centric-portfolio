...
export const blogs: Blog[] = [
   {
      ...
      date: "01 Mar 2026",
      readTime: "8 min read",
      tags: ["React Native", "Android", "QR Code", "Attendance", "Mobile App"],
      content: [
         {
            type: 'text',
            content: 'Managing classroom attendance has always been a tedious, error-prone task — paper registers get lost, proxy attendance is rampant, and tracking historical data manually is a nightmare. **Smart Attendance** was built to solve exactly these problems. It is a native Android application that leverages **QR code technology** and **role-based access** to make attendance tracking seamless for both teachers and students.'
         },
         {
            type: 'highlight',
            content: 'Smart Attendance eliminates manual roll calls entirely. Teachers scan a student\'s unique QR code, and the system records attendance instantly — no paper, no proxies, no hassle.'
         },
         {
            type: 'heading',
         ...
         {
            type: 'list',
            content: 'Core features of Smart Attendance:',
            items: [
         ...
         },
         {
            ...
            url: 'https://github.com/BuddhadebKoner/attendance-native-app'
         },
         {
            type: 'link',
            content: 'Download the latest release (APK)',
            url: 'https://github.com/BuddhadebKoner/attendance-native-app/releases/tag/smart-attdence'
         },
         {
            type: 'heading',
         ...
         {
            type: 'text',
            content: 'The **Student Dashboard** provides a clean, focused view for students. It displays all the classes a student is enrolled in, their attendance summary across classes, and quick access to their QR code for scanning. The student experience is intentionally streamlined — students see only what they need: their classes, their attendance, and their identity QR code.'
         },
         {
            type: 'image',
         ...
         {
            type: 'heading',
            content: 'Class Details — Student View'
         },
         {
            type: 'text',
         ...
         {
            type: 'text',
            content: 'The application is built using a modern mobile development stack designed for performance and maintainability:'
         },
         {
            type: 'list',
            content: 'Tech stack and architecture decisions:',
            items: [
         ...
         {
            type: 'heading',
            content: 'Key Challenges & Lessons Learned'
         },
         {
            type: 'text',
         ...
         {
            type: 'list',
            content: 'Key takeaways from the project:',
            items: [
         ...
         {
            type: 'highlight',
            content: 'The most important lesson: in a classroom tool, speed and simplicity win over feature richness. Teachers have 2-3 minutes for attendance, not 10.'
         },
         {
            type: 'heading',
            content: 'What\'s Next'
         ...
         {
            type: 'text',
            content: 'If you\'re interested in trying it out, you can download the latest APK from the GitHub releases page and install it on any Android device. Contributions and feedback are always welcome!'
         }
      ]
   },
   {
