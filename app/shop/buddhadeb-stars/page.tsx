...
export const metadata: Metadata = { title: "Buddhadeb Stars - Buddhadeb Koner" };

export default function BuddhadebStarsPage() {
   return (
      <div className="px-4 sm:px-6 lg:px-8 py-10 max-w-5xl mx-auto">
         <div className="flex items-center gap-3 mb-6">
            ...
            <h1 className="text-2xl sm:text-3xl font-bold text-foreground">Buddhadeb Stars</h1>
         </div>
