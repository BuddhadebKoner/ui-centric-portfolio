...
export default function SponsorAd({ sponsorId, position = "bottom-left", inline = false }: SponsorAdProps) {
   ...
   useEffect(() => {
      // Non-inline fixed cards: auto-expand on desktop
      if (!inline) {
   ...
   if (inline) {
      return (
         <div style={{ display: "flex", alignItems: "stretch", justifyContent: "flex-end" }}>
            ...
            >
               <a
                  ...
                  style={{
                     ...
                     boxShadow: "-3px 2px 16px rgba(32,33,36,.18)",
                     overflow: "hidden",
                  }}
               >
                  {/* AdChoices triangle */}
                  <div className="absolute top-0 right-0 z-10" style={{ width: 13, height: 13 }}>
                     <svg viewBox="0 0 15 15" width="13" height="13"><path d="M15 0v15L0 0z" fill="#4285f4" opacity="0.8" /></svg>
                  </div>
                  ...
                  <img
                     src={sponsor.image}
                     alt={sponsor.title}
                     style={{ width: 272, height: 142, objectFit: "cover", display: "block" }}
                     loading="lazy"
                  />
                  ...
                  <div style={{ padding: "10px 12px 12px" }}>
                     <div
                        ...
                        style={{
                           fontSize: 14, fontWeight: 700, lineHeight: "19px", color: "#202124",
                     ...
                     <div
                        style={{
                           marginTop: 3, fontSize: 12, lineHeight: "17px", color: "#1a73e8",
                           fontFamily: "Google Sans, Roboto, Arial, sans-serif",
                           display: "-webkit-box", WebkitLineClamp: 2, WebkitBoxOrient: "vertical", overflow: "hidden",
                        }}
                     >
                     ...
                     <div style={{ marginTop: 8, display: "flex", justifyContent: "flex-end" }}>
                        <span
                           ...
                           style={{
                              ...
                              padding: "6px 16px", borderRadius: 20, backgroundColor: "#202124",
            ...
            {/* ── Tab pill — always visible, anchors to right edge ── */}
            <button
               onClick={() => setExpanded((v) => !v)}
               aria-expanded={expanded}
               aria-label={expanded ? `Close ${sponsor.name} ad` : `View ${sponsor.name} ad`}
               style={{
                  display: "flex",
                  alignItems: "center",
                  gap: 5,
                  ...
                  border: "1px solid #e0e0e0",
                  borderRight: "none",
                  borderRadius: expanded ? "0 0 0 8px" : "8px 0 0 8px",
                  boxShadow: "-2px 2px 10px rgba(32,33,36,.18)",
                  cursor: "pointer",
                  userSelect: "none",
                  flexShrink: 0,
            ...
            >
               <span
                  style={{
                     fontSize: 9, color: "#70757a", backgroundColor: "#e8eaed",
               ...
               <svg
                  ...
                  fill="none" stroke="#5f6368" strokeWidth="2.5"
                  strokeLinecap="round" strokeLinejoin="round"
                  style={{ transition: "transform 280ms ease", transform: expanded ? "rotate(180deg)" : "rotate(0deg)", flexShrink: 0 }}
               >
   ...
   // ── Original fixed-position card variant ─────────────────────
   const outerClass = `${positionClasses[position]} z-40 w-[300px]`;

   return (
      <div className={outerClass}>
         {expanded && (
            <p className="text-[11px] font-normal mb-1 select-none pl-0.5" style={{ color: "#70757a" }}>Ad</p>
         )}
         <div
            style={{
               width: 300, backgroundColor: "#ffffff", border: "1px solid #e0e0e0",
               borderRadius: 8, boxShadow: "0 1px 6px rgba(32,33,36,.28)", overflow: "hidden",
            }}
         >
            <div
               style={{
                  display: "flex", alignItems: "center", justifyContent: "space-between",
                  padding: "8px 10px", borderBottom: expanded ? "1px solid #e8eaed" : "none",
            ...
            >
               <div style={{ display: "flex", alignItems: "center", gap: 7 }}>
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  <img src={sponsor.logo} alt={sponsor.name} style={{ height: 18, width: 18, objectFit: "contain", flexShrink: 0 }} loading="lazy" />
                  <span style={{ fontSize: 12, fontWeight: 600, color: "#202124", fontFamily: "Google Sans, Roboto, Arial, sans-serif", overflow: "hidden", whiteSpace: "nowrap", textOverflow: "ellipsis", maxWidth: 180 }}>{sponsor.name}</span>
                  <span style={{ fontSize: 10, color: "#70757a", fontFamily: "Google Sans, Roboto, Arial, sans-serif", backgroundColor: "#e8eaed", padding: "1px 5px", borderRadius: 3, flexShrink: 0 }}>Ad</span>
               </div>
               <span style={{ display: "inline-flex", alignItems: "center", justifyContent: "center", width: 24, height: 24, borderRadius: "50%", backgroundColor: "#e8eaed", flexShrink: 0 }}>
                  <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#5f6368" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" style={{ transition: "transform 250ms ease", transform: expanded ? "rotate(180deg)" : "rotate(0deg)" }}>
                     <path d="M6 9l6 6 6-6" />
                  </svg>
               </span>
            </div>
            <div style={{ maxHeight: expanded ? 400 : 0, overflow: "hidden", transition: "max-height 300ms ease" }}>
               <a href={sponsor.ctaUrl} target="_blank" rel="noopener noreferrer sponsored" className="group block relative" style={{ textDecoration: "none" }}>
                  <div className="absolute top-0 right-0 z-10" style={{ width: 15, height: 15 }}>
                     <svg viewBox="0 0 15 15" width="15" height="15"><path d="M15 0v15L0 0z" fill="#4285f4" opacity="0.85" /></svg>
                  </div>
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  <img src={sponsor.image} alt={sponsor.title} style={{ width: 300, height: 157, objectFit: "cover", display: "block" }} loading="lazy" />
                  <div style={{ padding: "10px 12px 12px" }}>
                     <div className="group-hover:underline" style={{ fontSize: 15, fontWeight: 700, lineHeight: "20px", color: "#202124", fontFamily: "Google Sans, Roboto, Arial, sans-serif", display: "-webkit-box", WebkitLineClamp: 2, WebkitBoxOrient: "vertical", overflow: "hidden" }}>{sponsor.title}</div>
                     <div style={{ marginTop: 4, fontSize: 13, lineHeight: "18px", color: "#1a73e8", fontFamily: "Google Sans, Roboto, Arial, sans-serif", display: "-webkit-box", WebkitLineClamp: 2, WebkitBoxOrient: "vertical", overflow: "hidden" }}>{sponsor.description}</div>
                     <div style={{ display: "flex", alignItems: "center", justifyContent: "flex-end", marginTop: 10 }}>
                        <span className="group-hover:opacity-80" style={{ display: "inline-flex", alignItems: "center", justifyContent: "center", width: 36, height: 36, borderRadius: "50%", backgroundColor: "#202124", transition: "opacity 200ms", flexShrink: 0 }}>
                           <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#ffffff" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M9 5l7 7-7 7" /></svg>
                        </span>
                     </div>
                  </div>
               </a>
